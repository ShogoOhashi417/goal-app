...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class='flex flex-col min-h-screen'>
                            ...
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th class='w-10'>
                                            <a type="button" id="addTodoList"><i class="fas fa-plus"></i></a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
            ...
            <div id="addTodoListModal" class="fixed top-0 left-0 w-full h-full flex items-center justify-center hidden">
                ...
                <div class="z-10 bg-white p-6 rounded shadow-lg w-1/2">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <button id="closeModal" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="addTodoListModal">
            ...
            <script>
                ...
                const addTodoListModal = document.getElementById('addTodoListModal');

                addTodoListButton.addEventListener('click', () => {
                    addTodoListModal.classList.remove('hidden');
                });

                closeModalButton.addEventListener('click', () => {
                addTodoListModal.classList.add('hidden');
                });
            </script>
